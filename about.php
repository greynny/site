	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent text-justify">
                ...
                <p>Готовність людини до трудової діяльності визначається його психологічною та практичною готовністю.
                    Виховання психологічної та практичної готовності до праці є необхідною умовою вирішення завдань професійної орієнтації учнів.
			...
			<aside class="col-sm-4 sidebar sidebar-right">
				...
				<div class="widget text-justify">
					...
					<ul class="list-unstyled list-spaces">
						<li><a href="">Навчальний заклад</a><br><span class="small text-muted">Перелік спеціальностей, та професій, які можна здобути в навчальному закладі</span></li>
						<li><a href="">Пошук професій</a><br><span class="small text-muted">Пошук спеціальностей, та професій, які можна здобути в навчальному заклад</span></li>
